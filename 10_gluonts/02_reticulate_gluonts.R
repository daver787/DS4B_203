...
py$dict("key1" = "value 1", "key2" = "value 2") %>% class()

py$dict("key1" = "value 1", "key2" = "value 2") %>% py_to_r() %>% class()

py_eval("{'key1':'value1'}", convert =FALSE) %>% class()
...
data_prepared_list_dataset$list_data[0] %>% class()

data_prepared_list_dataset$list_data[0]["target"]
